...
class appPre_prodProjectContainer extends Container
{
    private $parameters;
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_f1a8a4e4d7859374f62ce88e3cc2ebe8b489056fd5e2356e3d551fbda34b2def');
        return $instance;
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler(($this->targetDirs[2].'\\logs/pre_prod.log'), 100, true, NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.container_class' => 'appPre_prodProjectContainer',
            ...
            'router.options.matcher.cache_class' => 'appPre_prodUrlMatcher',
            'router.options.generator.cache_class' => 'appPre_prodUrlGenerator',
            'router_listener.class' => 'Symfony\\Component\\HttpKernel\\EventListener\\RouterListener',
            'router.request_context.host' => 'localhost',
            'router.request_context.scheme' => 'http',
            'router.request_context.base_url' => '',
            'router.resource' => ($this->targetDirs[2].'/config/routing.yml'),
            'router.cache_class_prefix' => 'appPre_prod',
